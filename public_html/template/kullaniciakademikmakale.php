...
<title>Tüm Akademik Makaleleri</title>
...
try {
    ...
    if($articles){
        foreach($articles as $article){
            ...
            echo '<p><b>Amacı:</b> '.htmlspecialchars($article['purpose']).'</p>';
            echo '<p><b>Hedef Kitle:</b> '.htmlspecialchars($article['audience']).'</p>';
