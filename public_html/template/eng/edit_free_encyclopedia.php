...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($title === '' || $content === '') {
        ...
        try {
            $stmt = $db->prepare("UPDATE encyclopedia_posts2 
            ...
            header("Location: /free_encyclopedia_detail?id=".$id);
            exit;
        } catch(PDOException $e){
...
<title>Edit - <?php echo htmlspecialchars($encyclopedia['title']); ?></title>
...
<div class="container">
    ...
    <form method="post">
        ...
        <div class="buttons">
            <a href="/free_encyclopedia_detail?id=<?php echo $id; ?>" class="back-btn">Back</a>
