...
<title>User's Academic Articles</title>
...
<h1>User's Academic Articles</h1>
...
try {
    ...
    if($articles){
        foreach($articles as $article){
            ...
            echo '<p><b>Purpose:</b> '.htmlspecialchars($article['purpose']).'</p>';
            echo '<p><b>Target Audience:</b> '.htmlspecialchars($article['audience']).'</p>';
