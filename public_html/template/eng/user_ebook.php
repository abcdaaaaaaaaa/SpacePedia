...
<h1>User's e-books</h1>
<form method="get" action="">
    <input type="text" name="search" placeholder="Search for e-book..." value="<?php echo htmlspecialchars($search); ?>">
...
try {
    ...
    if($articles){
        foreach($articles as $article){
            $url = !empty($article['pdf']) ? '/template/ebook_viewer.php?file='.urlencode($article['pdf']) : '#';
        ...
        echo "<div class='no-articles'>No results matched your search for e-books.</div>";
    }
