...
<header>
    <a href="/duzenleozguransiklopedi?id=<?php echo $encyclopedia['id']; ?>" class="edit-btn">Düzenle</a>
    <h1 style="color: #ff9800;"><?php echo htmlspecialchars($encyclopedia['title']); ?></h1>
    <a href="/delete_encyclopedia_post.php?id=<?php echo $encyclopedia['id']; ?>" class="delete-btn" onclick="return confirm('Bu ansiklopediyi silmek istediğinizden emin misiniz?');">Sil</a>
</header>
