...
<title>Tüm Öğretici Makaleler</title>
...
try {
    ...
    if ($search) {
        $sql .= " AND (
            ...
            OR DATE_FORMAT(blog_posts.created_at, '%d-%m-%Y') LIKE :search
        )";
    ...
    if ($articles) {
        foreach ($articles as $article) {
            ...
            echo '<a class="article-box" target="_blank" href="/ogreticimakaledetay?id='.$article['id'].'">';
